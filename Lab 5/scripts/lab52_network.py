...
def run():
    ...
    link_r1r2.intf1.config( bw=3, enable_ecn=True, enable_red=True)
    link_r2h4.intf1.config( bw=2, enable_ecn=True, enable_red=True)
    link_r2h3.intf1.config( bw=1, enable_ecn=True, enable_red=True)
